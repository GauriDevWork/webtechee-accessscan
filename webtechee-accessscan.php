...
Text Domain: accessibility-site-scanner
...
define( 'WTAC_PATH', plugin_dir_path( __FILE__ ) );

require_once WTAC_PATH . 'includes/class-scanner.php';
require_once WTAC_PATH . 'includes/class-admin-ui.php';
